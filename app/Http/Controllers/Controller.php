...
//        $meterReadingPeriodEnd = 2;
        ...
        $this->metersDataPeriodEnd = Carbon::create($todayYear, $todayMonth, $meterReadingPeriodEnd, 24, 0, 0, 'Asia/Yekaterinburg');
