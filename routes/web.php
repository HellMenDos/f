...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin'], function () {
    ...
    Route::group(['middleware' => ['auth:admin', 'permission']], function () {
        ...
        Route::get('/save', 'HomeController@save')->name('admin.dashboard.save');
        Route::post('/{id}/update', 'HomeController@update')->name('admin.dashboard.update');
        ...
        Route::resource('normative-docs', 'NormativeDocsController', ['except' => ['show', 'destroy']])->names('admin.normative-docs');
        Route::get('normative-docs/{id}/download_file','NormativeDocsController@download_file')->name('admin.normative-docs.download_file');
        Route::get('normative-docs/{id}/activate', 'NormativeDocsController@activate')->name('admin.normative-docs.activate');
        Route::get('normative-docs/{id}/deactivate', 'NormativeDocsController@deactivate')->name('admin.normative-docs.deactivate');
        Route::get('normative-docs/{id}/delete', 'NormativeDocsController@delete')->name('admin.normative-docs.delete');
        ...
        Route::namespace('Services')->group(function () {
            ...
            Route::get('services/{id}/delete', 'ServiceController@delete')->name('admin.services.delete');
            Route::get('services/{id}/deactivate', 'ServiceController@deactivate')->name('admin.services.deactivate');
            Route::get('services/{id}/activate', 'ServiceController@activate')->name('admin.services.activate');

            Route::resource('service-request', 'ServiceRequestController', ['except' => ['destroy']])->names('admin.services.request');
            Route::get('service-request/{id}/accept', 'ServiceRequestController@accept')->name('admin.services.request.accept');
            Route::get('service-request/{id}/complete', 'ServiceRequestController@complete')->name('admin.services.request.complete');
            Route::get('service-request/{id}/delete', 'ServiceRequestController@delete')->name('admin.services.request.delete');

            Route::resource('services-group', 'ServiceGroupController', ['except' => ['destroy', 'show']])->names('admin.services.group');
            ...
            Route::resource('service-executors', 'ServiceExecutorController', ['except' => ['destroy']])->names('admin.services.executors');
            Route::get('service-executors/{id}/deactivate', 'ServiceExecutorController@deactivate')->name('admin.services.executors.deactivate');
            Route::get('service-executors/{id}/activate', 'ServiceExecutorController@activate')->name('admin.services.executors.activate');
            Route::get('service-executors/{id}/delete', 'ServiceExecutorController@delete')->name('admin.services.executors.delete');
        });
