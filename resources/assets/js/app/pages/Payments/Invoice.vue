				...
				<table class="invoice">
					<tbody>
						...
						<tr class="bordered">
							...
							<td class="text-right" colspan="2">{{ LAST_PAYMENT.payment && LAST_PAYMENT.tariff.electricity_day }} &#8381;</td>
	...
	export default {
		...
		computed: {
			...
			electricityCost: function () {
				if (this.LAST_PAYMENT.meters && this.LAST_PAYMENT.meters.currency) {
					return parseFloat(this.LAST_PAYMENT.meters.currency.electricity_day - this.LAST_PAYMENT.meters.prev.electricity_day).toFixed(2);
				}
			},
			...
			electricityTotal: function () {
				if (this.LAST_PAYMENT.tariff && this.LAST_PAYMENT.tariff.electricity_day) {
					return parseFloat(this.LAST_PAYMENT.tariff.electricity_day * this.electricityCost).toFixed(2);
				}
			},
