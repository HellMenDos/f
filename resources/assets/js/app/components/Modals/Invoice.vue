			...
			<table class="invoice">
				<tbody class="printable">
					...
					<tr class="bordered">
						...
						<td class="text-right" colspan="2">{{ modalData.tariff && modalData.tariff.electricity_day }} &#8381;</td>
	...
	export default {
		...
		computed: {
			...
			electricityCost: function () {
				if (this.modalData.meters && this.modalData.meters.currency) {
					return parseFloat(this.modalData.meters.currency.electricity_day - this.modalData.meters.prev.electricity_day).toFixed(2);
				}
			},
			...
			electricityTotal: function () {
				if (this.modalData.tariff && this.modalData.tariff.electricity_day) {
					return parseFloat(this.modalData.tariff.electricity_day * this.electricityCost).toFixed(2);
				}
			},
