        ...
        <script>
            window.onload = function() {
                let toggleChat = document.querySelector('#toggle-chat'),
                    bodyChat = document.querySelector('#body-chat'),
                    closeChat = document.querySelector('#close-chat'),
                    iconChatFile = document.querySelector('#icon-chat-file'),
                ...
                // iconChatFile.addEventListener('click', (e) => {
                //     e.preventDefault();
                //     chatFile.dispatchEvent(new Event('click'));
                // });
            }
        </script>
	@yield('after-scripts')
