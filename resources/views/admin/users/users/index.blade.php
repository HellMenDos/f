                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right">
                                            ...
                                            @if (CurrentUser::id() != $user->user_id)
                                                @if ($user->status != 'deleted')
                                                    <li>
                                                        @if($user->status == 'on')
                                                            <a href="{{ route('admin.users.deactivate', $user->user_id) }}" onclick="return confirmMessage('Вы подтверждаете отключение? Ему будет не доступен вход.')"><i class="fa fa-thumbs-o-down"></i> Выключить</a>
                                                        @else
                                                            <a href="{{ route('admin.users.activate', $user->user_id) }}" onclick="return confirmMessage('Вы подтверждаете включение? Ему будет доступен вход.')"><i class="fa fa-thumbs-o-up"></i> Включить</a>
                                                        @endif
                                                    </li>
