...
@section('after-scripts')
    <script>
        $(document).ready(function() {
            ...
            if (tab) {
                $('#tabs a[href="#' + tab.get('tab') + '"]').tab('show');
            }
        });
    </script>
@endsection
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade in active" id="tab-profile">
                            <table class="table table-striped">
                                ...
                                <tr>
                                    <th>Процент голосов от общей площади участков</th>
                                    <td>{{$area->area_vote_percent}} % </td>
                                </tr>
                                <tr>
                        ...
                        <div class="tab-pane fade in" id="tab-meters-data">
                            ...
                            @if ($noMetersData && ! $metersDataPeriodEnded && ! $metersDataPeriodNotStarted)
                                <br>
                                <a href="javascript:;"
                                   class="js-modal btn btn-primary"
                                   data-remote="{{ route('admin.areas.ajax_set_meters', $area->id) }}"
                                >Внести показания за {{ getCurrencyMonth() }}</a>
                                <br><br>
                            @endif
                            <table class="table table-striped table-condensed">
                                <thead>
                                    <tr>
                                        <th>Вода, м<sup>3</sup></th>
