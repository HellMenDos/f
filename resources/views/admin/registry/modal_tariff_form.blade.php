<form action="javascript:;" id="ajax-tariff-form" method="post" accept-charset="utf-8">
    ...
    <div class="form-group">
        ...
        <input type="number" min="0" step="0.01" name="tariff[water]" value="" id="tariff_cold_water" class="form-control" required="">
    </div>
    <div class="form-group">
        <label for="tariff_electricity">Электроэнергия, руб. <span class="required">*</span></label>
        <input type="number" min="0" step="0.01" name="tariff[electricity]" value="" id="tariff_electricity" class="form-control" required="">
    </div>
    <div class="form-group">
        <label for="tariff_electricity_night">Электроэнергия (ночь), руб. <span class="required">*</span></label>
        <input type="number" min="0" step="0.01" name="tariff[electricity_night]" value="" id="tariff_electricity_night" class="form-control" required="">
    </div>
    <div class="form-group">
        <label for="tariff_start_day">Дата начала действия <span class="required">*</span></label>
        <input type="date" name="tariff[start_day]" value="" id="tariff_start_day" class="form-control" required="">
    </div>
    <div class="form-group">
