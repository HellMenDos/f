...
class SettingsSeeder extends Seeder
{
    ...
    public function run()
    {
        $data = [
            ...
            [
                'id' => 50,
                'key' => 'user_send_billing',
                'description' => 'Высылать письмо с квитанцией на оплату услуг ЖКХ',
                'value' => '0',
                'help' => null,
                'ordering' => 0,
                'type' => 'user',
            ...
            [
                'id' => 51,
                'key' => 'user_notification_time_from',
                'description' => 'Желаемое время для напоминаний сдачи показаний, от',
                'value' => null,
                'help' => null,
                'ordering' => 0,
                'type' => 'user',
            ...
            [
                'id' => 52,
                'key' => 'user_notification_time_to',
                'description' => 'Желаемое время для напоминаний сдачи показаний, до',
                'value' => null,
                'help' => null,
                'ordering' => 0,
                'type' => 'user',
